...
Future<void> updateCategorydata(int cat_id, double amount) async {
  ...
  if (response.statusCode == 200) {
    ...
    print('Failed to update category data. Status code: ${response.statusCode}');
  }
}
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Text(
                                              categorylimits[index].category_limit.toDouble().toStringAsFixed(2),
                                              style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 20,
                                              ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Text(
                                              overalllimits[index].overall_limit.toDouble().toStringAsFixed(2),
                                              style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 20,
                                              ),
...
Future<void> editCategoryPopup(BuildContext context, categorylimit category) async {
...
Future<void> editOverallPopup(BuildContext context, overalllimit overall) async {
  final TextEditingController _amountController = TextEditingController(
